...
namespace MyFSM.Unity
{
    public static class ClassGenerator
    {
                                            ...
                                            string resourcePath)
        {
            ...
            sb.AppendLine("// Self-contained: the module bytes below are this AI's brain.");
            ...
            if (moduleBytes != null && moduleBytes.Length > 0)
            {
                ...
                sb.AppendLine("    // The compiled module, embedded at generation time. Nothing needs");
                sb.AppendLine("    // to be assigned: drop this component on a GameObject and press Play.");
                sb.AppendLine("    // Assign a module asset in the inspector to override it.");
