...
"getColor":"SpriteRenderer.color (RGBA).","setColor":"Writes SpriteRenderer.color (Tier 2).",
...
"hasReachedDestination":"Within the agent's stopping distance of a point/object (default 0.2 without a NavMeshAgent).",
"goTo":"Posts a Point goal at the agent's navigation speed. The destination is **snapshotted** now.",
...
A("argument, or a fixed vs a caller-supplied speed.")
A("")
